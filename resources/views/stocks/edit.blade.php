    ...
    <div class="container">
        ...
        <form action="{{ route('stocks.update', $stock->id) }}" method="POST">
            ...
            <div class="col">
                ...
                <input type="number" step="0.01" min="0" name="prix_unitaire" class="form-control"
                    value="{{ $stock->prix_unitaire }}" required>
            </div>
            <div class="form-group">
                <label for="stock_initial">Stock Initial</label>
                <input type="number" name="stock_initial" class="form-control" value="{{ $stock->stock_initial }}"
                    required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" name="stock_minimum" class="form-control" value="{{ $stock->stock_minimum }}"
                    required>
            </div>
