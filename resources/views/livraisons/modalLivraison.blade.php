                    ...
                    <div class="popup text-left">
                        <div class="content create-workform bg-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <label class="mb-2">A livré par</label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <label class="mb-2">Commentaires</label>
                                    <textarea class="form-control" rows="1" disabled>{{ $livraison->commentaires ?? '-' }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <select name="moyen_livraison" class="custom-select @error('moyen_livraison') is-invalid @enderror" required>
                                            ...
                                            <option value="Livreur" {{ old('moyen_livraison', $livraison->moyen_livraison) == 'Livreur' ? 'selected' : '' }}>Livreur</option>
                                            <option value="Aucun" {{ old('moyen_livraison', $livraison->moyen_livraison) == 'Aucun' ? 'selected' : '' }}>Aucun</option>
                                        </select>
                                        @error('moyen_livraison')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
