                                ...
                                <tbody>
                                    @forelse ($livraisons as $livraison)
                                        <tr>
                                            ...
                                            <td class="
                                                {{ 
                                                    $livraison->date_livraison->isPast() && $livraison->statut_livraison === 'Non Livrée' ? 'text-danger font-weight-bold' : 
                                                    ($livraison->date_livraison->isPast() && $livraison->statut_livraison === 'Livrée' ? 'text-success font-weight-bold' : '') 
                                                }}
                                            ">
