                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col">
                                                ...
                                                <select name="produit_id" class="custom-select" required>
                                                    ...
                                                    @foreach($stocks as $stock)
                                                        <!-- <option value="{{ $stock->id }}">{{ $stock->nom_produit }}</option> -->
                                                        @php
                                                            $disponible = $stock->stock_initial + $stock->entrees - $stock->sorties;
                                                        @endphp
                                        ...
                                        <div class="form-row mb-3">
                                            <div class="col">
                                                ...
                                                <select class="custom-select form-control-sm" name="client_id">
                                        ...
                                        <div class="form-row mb-3">
                                            <div class="col">
                                                ...
                                                <input type="number" name="quantite_vendue" class="form-control" required>
                                                @if ($errors->has('quantite_vendue'))
                                                    <small class="text-danger">{{ $errors->first('quantite_vendue') }}</small>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="livreur_id" class="custom-select">
                                                ...
                                                @foreach($livreurs as $livreur)
                                                    <option value="{{ $livreur->id }}">{{ $livreur->nom_livreur }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                        ...
                        <div class="content create-workform bg-body">
                            <div class="form-row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="nom_produit" class="form-control" value="{{ optional($vente->livraison)->nom_client ?? 'Non définie' }}" disabled >
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" name="nom_produit" class="form-control" value="{{ optional($vente->livraison)->date_livraison ?? 'Non prévue' }}" disabled >
                                </div>
                                <div class="col">
                                    <label class="mb-2">Statut de livraison</label>
                                    <input type="text" name="entrees" class="form-control" value="{{ optional($vente->livraison)->statut_livraison ?? 'Non définie' }}" disabled >
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="content create-workform bg-body">
                            ...
                            <form action="{{ route('ventes.update', $vente->id) }}" method="POST">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label class="mb-2">Quantité Vendue</label>
                                        <input type="number" name="quantite_vendue" class="form-control" value="{{ $vente->quantite_vendue }}" required>
                                    </div>
                                    <div class="col">
                                        <label class="mb-2">Prix Unitaire</label>
                                        <input type="number" name="prix_unitaire" class="form-control" value="{{ $vente->prix_unitaire }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label class="mb-2">Total d'achat</label>
                                        <input type="text" class="form-control" value="{{ $vente->quantite_vendue * $vente->prix_unitaire }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <select name="mode_paiement" class="custom-select" required>
                                            <option value="Espèces" {{ $vente->mode_paiement == 'Espèces' ? 'selected' : '' }}>En espèces</option>
                                            <option value="Mobile money" {{ $vente->mode_paiement == 'Mobile money' ? 'selected' : '' }}>Mobile money</option>
                                            <option value="Chèque" {{ $vente->mode_paiement == 'Chèque' ? 'selected' : '' }}>Chèque</option>
                                            <option value="À la livraison" {{ $vente->mode_paiement == 'À la livraison' ? 'selected' : '' }}>À la livraison</option>
                                        </select>
                                    </div>
                                </div>
