                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-4 card-total-sale">
                                            <div class="icon iq-icon-box-2 bg-info-light">
                                                <img src="../assets/images/product/shop.png" class="img-fluid" alt="image">
                                            </div>
                                            <div>
                                                <p class="mb-2">Stock | Rupture</p>
                                                <h4>
                                                    <span data-toggle="modal" data-target="#stock-Modal" style="cursor: pointer;">
                                                        {{ $totalProduitsEnStock }}
                                                    </span> |
                                                    <span class="text-danger" data-toggle="modal" data-target="#rupture-Modal" style="cursor: pointer;">
                                                        {{ $produitsEnRupture }}
                                                    </span>
                                                </h4>
                                            </div>
                                        ...
                                        <div class="iq-progress-bar mt-2">
                                            <span class="bg-info iq-progress progress-1" data-percent="{{ ($totalProduitsEnStock > 0 ? (1 - $produitsEnRupture / $totalProduitsEnStock) * 100 : 0) }}">
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-4 card-total-sale">
                                            <div class="icon iq-icon-box-2 bgrose">
                                                <img src="../assets/images/product/chart.png" class="img-fluid" alt="image">
                                            </div>
                                            <div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-4 card-total-sale">
                                            <div class="icon iq-icon-box-2 bgblue">
                                                <img src="../assets/images/product/livraison.png" class="img-fluid" alt="image">
                                            </div>
                                            <div>
