<!-- Ajouter du stocks  -->
<div class="modal fade" id="add-trasaction-Modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Ajouter une trasaction</h4>
                ...
                <div class="popup text-left">
                    <div class="content create-workform bg-body">
                        <form action="{{ route('finances.store') }}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <label class="mb-2">Types de transaction</label>
                                    <!-- <input type="text" name="nom_produit" class="form-control" required> -->
                                    <select class="custom-select">
                                        <option selected>Retrais</option>
                                        <option value="1">Depot</option>
                                    </select>
                                </div>
                                <div class="col">
                                    <label class="mb-2">Montants</label>
