...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>TASSIVA Dash | Login</title>
      
      <!-- Favicon -->
      <link rel="shortcut icon" href="{{ asset('assets/images/logotassiva.webp') }}" />
                        ...
                        <div class="d-flex align-items-center auth-content">
                           <div class="col-lg-7 align-self-center">
                              <div class="p-3">
                                 ...
                                 <p>Connectez-vous pour rester connecté.</p>
                                    @if ($errors->any())
                                        <div style="color:red;">
                                            <ul>
                                                @foreach ($errors->all() as $error)
                                 ...
                                 <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-lg-6">
                                          <a href="auth-recoverpw.html" class="text-primary float-right">mot de passe oublier?</a>
                                       </div>
                                    </div>
                           ...
                           <div class="col-lg-5 content-right">
                              <img src="../assets/images/logintassiva.webp" class="img-fluid image-right" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
