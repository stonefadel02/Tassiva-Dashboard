...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Finance>|Finance whereDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Finance>|Finance whereTypeTransaction($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Finance>|Finance whereCategorie($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Finance>|Finance whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Finance>|Finance whereMontant($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Finance>|Finance whereEntreeSortie($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Finance>|Finance whereSolde($value)
    ...
    /**
     * App\Models\Livraison
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property string|null $commentaires
     * @property int|null $delai_livraison
     * @property string $statut_livraison
     * @property string $moyen_livraison
     * @property string $adresse_livraison
     * @property string $nom_client
     * @property string $id_client
     * @property string $id_commande
     * @property string $date_livraison
     * @property string $date_commande
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison whereDateCommande($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison whereDateLivraison($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison whereIdCommande($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison whereIdClient($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison whereNomClient($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison whereAdresseLivraison($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison whereMoyenLivraison($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison whereStatutLivraison($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison whereDelaiLivraison($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison whereCommentaires($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Livraison>|Livraison query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Livraison extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property bool $rupture
     * @property int $stock_minimum
     * @property int|null $stock_actuel
     * @property int $sorties
     * @property int $entrees
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Stock>|Stock whereNomProduit($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Stock>|Stock whereStockInitial($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Stock>|Stock whereEntrees($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Stock>|Stock whereSorties($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Stock>|Stock whereStockActuel($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Stock>|Stock whereStockMinimum($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Stock>|Stock whereRupture($value)
     ...
     * @property float|null $total_vente
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Vente>|Vente whereDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Vente>|Vente whereProduitId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Vente>|Vente whereNomProduit($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Vente>|Vente whereQuantiteVendue($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Vente>|Vente wherePrixUnitaire($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Vente>|Vente whereTotalVente($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Vente>|Vente whereModePaiement($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Vente>|Vente whereCommentaires($value)
